...
export const handler: Schema["getGpsDataWithTime"]["functionHandler"] = async (event) => {
    ...
    const formattedStart = event.arguments.startTime;
    const formattedEnd = event.arguments.endTime;
